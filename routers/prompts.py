...
예제:
   제품: ["갤럭시 S24", "S24", "갤럭시 24", "갤S24",  "갤24"] -> "갤럭시 S24", 
            ["갤럭시 S24 플러스", "S24+", "갤럭시 24+", "갤S24+",  "갤24+"]  -> "갤럭시 S24 플러스",
            ["갤럭시 S24 울트라", "S24U", "갤럭시 24 Ultra", "갤S24U",  "갤24U"]  -> "갤럭시 S24 울트라"
   모델: SM-S916NZKEKOO
   시리즈: 갤럭시 S24 시리즈
...
Key: "question", "products", "models", "series", "comparison_yesno", "description_yesno",
    "samsung_product_yesno",  "othercompany_product_yesno", "feature", "method"

질문:
"""

comparison_generation_prompt = f"""
